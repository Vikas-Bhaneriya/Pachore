...
var sphereMaterial = new THREE.MeshPhongMaterial({ map: THREE.ImageUtils.loadTexture('vik.jpg') });
...
var plane1Material = new THREE.MeshBasicMaterial( {map: THREE.ImageUtils.loadTexture('vik.jpg'), side: THREE.DoubleSide} );
...
var plane2Material = new THREE.MeshBasicMaterial( {map: THREE.ImageUtils.loadTexture('vik.jpg'), side: THREE.DoubleSide, transparent: true, opacity: 0.7} );
