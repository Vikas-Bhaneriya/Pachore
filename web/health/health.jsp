...
<head>
  ...
  <meta name="viewport" content="width=900px, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
 ...
 <script>
    ...
    var i=0;
      ...
      $(window).scroll(function() {
       ...
       document.getElementById("heading").innerHTML=""+ school[l-1] ;
